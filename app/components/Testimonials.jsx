export default function Testimonials(){
  return(
    <section className="bg-base-200 dark:text-gray-800">
	<div className="container px-6 py-12 mx-auto">
		<div className="grid items-center gap-4 xl:grid-cols-5">
			<div className="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
				<h2 className="text-4xl font-bold dark:text-white">Kata Mereka yang Puas dengan El.Husain Travel</h2>
						...
						<div className="p-6 rounded shadow-md bg-base-100">
							...
							<div className="flex items-center mt-4 space-x-4">
								...
								<div>
									...
									<p className="text-sm 0 text-white">CTO of Company Co.</p>
								</div>
							</div>
						</div>
						<div className="p-6 rounded shadow-md bg-base-100">
							<p className="text-white">Sit wisi sapientem ut, pri civibus temporibus voluptatibus et, ius cu hinc fabulas. Nam meliore minimum et, regione convenire cum id. Ex pro eros mucius consectetuer, pro magna nulla nonumy ne, eam putent iudicabit consulatu cu.</p>
							<div className="flex items-center mt-4 space-x-4">
