					...
					<div className="grid content-center gap-4">
						<div className="p-6 rounded shadow-md bg-base-100">
							...
							<div className="flex items-center mt-4 space-x-4">
								...
								<div>
									<p className="text-lg font-semibold text-gray">Leroy Jenkins</p>
									<p className="text-sm 0 text-gray">CTO of Company Co.</p>
								</div>
							</div>
						</div>
						<div className="p-6 rounded shadow-md bg-base-100">
							<p className="text-gray">Sit wisi sapientem ut, pri civibus temporibus voluptatibus et, ius cu hinc fabulas. Nam meliore minimum et, regione convenire cum id. Ex pro eros mucius consectetuer, pro magna nulla nonumy ne, eam putent iudicabit consulatu cu.</p>
							<div className="flex items-center mt-4 space-x-4">
								...
								<div>
									<p className="text-lg font-semibold text-gray">Leroy Jenkins</p>
									<p className="text-sm text-gray">CTO of Company Co.</p>
								</div>
							</div>
						</div>
					</div>
